...
virtualenv ansibledoduoproject
source /home/vagrant/ansibledoduoproject/bin/activate
...
cp --force /shared_folder/ansible_playground/Roles/Firewalld/tasks/main.yml ~/ansible_playground/Firewalld/tasks/
